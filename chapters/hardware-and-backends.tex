...
The \texttt{wish01} GPT21 run is an example of realistic small-lab engineering. It used:
...
This number is not a universal benchmark. It is a local baseline for this exact model,
data, code, hardware, and configuration.
