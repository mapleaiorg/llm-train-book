...
\node[box, fill=green!10] (shards) at (12,0) {shards\\\texttt{train\_000.bin}};
...
Data path & \texttt{data/tokens/wikitext103/*.bin} & Token dtype, endianness, and split identity must be documented. \\
