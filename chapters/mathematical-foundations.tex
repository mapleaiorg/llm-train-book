...
Attention will receive a full chapter later, but the core visual idea is useful now. A context vector is a weighted combination of input vectors. The weights decide how much each earlier token contributes.
...
\node[vec, fill=red!10] at (3.45,-1.65) {0.43};
\node[vec, fill=red!10] at (4.0,-1.65) {0.29};
\node[vec, fill=red!10] at (4.55,-1.65) {0.29};
